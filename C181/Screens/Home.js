        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.subheading1}>Try Out</Text><Text style={styles.subheading2}> Cool Hats</Text>
                    </View>
                </View>
                <View style={styles.contentContainer}>
                    <View style={{ flex: 0.5 }}>
                        <Text style={styles.contentText}>Experience the virtual experience of trying out different Filters from our wide collection on your mobile phone before making any purchase, just how you would in an offline store!</Text>
                    </View>
                    <View style={{ flexDirection: "row", flex: 0.25 }}>
                        ...
                        <View style={{ flex: 0.5 }}>
                            <Image source={require('../assets/hat-pic2.png')} style={{ height: 64, width: 160 }} />
                        </View>
                    </View>
                    <View style={{ flexDirection: "row", flex: 0.25 }}>
                        <View style={{ flex: 0.5 }}>
